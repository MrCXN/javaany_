...
public class ListToMapTest {
    ...
    public static void main(String[] args) {
        List<String> runChannelList = Arrays.asList("wx");
        System.out.println(JSONObject.toJSONString(runChannelList));
...
//
//
//        List<Merchant> collect = merchants.stream().filter(a -> a.getCount() == 200).filter(a->  a.getGroupId().equals("234")).collect(Collectors.toList());
//
