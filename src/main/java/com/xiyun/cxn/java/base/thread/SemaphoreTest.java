        ...
        for (int i = 0; i < 10; i++) {
            ...
            Runnable runnable = new Runnable() {
                public void run() {
                    ...
                    System.out.println("线程" + Thread.currentThread().getName() + "进入，当可用有" + (sp.availablePermits()) + "个并发");
                    try {
                    ...
                    System.out.println("线程" + Thread.currentThread().getName() + "已离开，当可用有" + (sp.availablePermits()) + "个并发");
                }
            };
